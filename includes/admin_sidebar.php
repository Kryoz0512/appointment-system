...
<<<<<<< HEAD
   ...
   class="group relative flex items-center gap-3 px-3 py-3 rounded-xl overflow-hidden transition-all duration-300 <?php echo $is_active
    ...
    <!-- Icon -->
    <svg class="relative z-10 w-5 h-5 shrink-0"
         fill="none"
         stroke="currentColor"
         viewBox="0 0 24 24">
        <?php echo $item['icon']; ?>
    ...
    <!-- Label -->
    <span class="relative z-10 text-sm whitespace-nowrap sidebar-label">
        <?php echo $item['label']; ?>
    </span>
...
=======
    <nav class="flex-1 px-4 py-8 space-y-2">
        ...
        <a href="transaction_types.php" class="w-full flex items-center px-4 py-3.5 rounded-xl transition-all text-left border <?php echo $current_page == 'transaction_types.php' ? 'bg-indigo-800/80 text-white font-semibold shadow-inner border-indigo-700/50' : 'text-indigo-200 hover:bg-indigo-800/50 hover:text-white font-medium border-transparent'; ?>">
            <svg class="w-5 h-5 mr-3 <?php echo $current_page == 'transaction_types.php' ? 'text-indigo-300' : 'opacity-70'; ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
            Transaction Types
        </a>
