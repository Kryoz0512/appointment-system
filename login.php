...
<head>
    ...
    <title>Tax Appointment Booking - Login</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 fade-in">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 mt-2">Sign in to book or manage your appointments</p>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-slate-500">
            <p>Admin Login Check: Use <b>admin2@test.com</b> / <b>admin123</b></p>
            <p class="mt-2">Don't have an account? <a href="register.php" class="text-indigo-600 hover:text-indigo-800 font-medium">Register here</a></p>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            if (res && res.success) {
                ...
                showToast(res ? res.error : 'Login failed', 'error');
